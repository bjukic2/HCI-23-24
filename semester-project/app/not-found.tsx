...
export default function NotFound() {
  return (
    <main className="text-4 mt-35 flex flex-col items-center gap-4 text-center text-brand-700 md:text-2xl">
      <Image src={closed_icon} alt="" className="h-28 w-28" />
      <p>Žao nam je, nismo mogli pronaći stranicu koju tražite.</p>
      <p>
        Vratite se na {" "}
        <Link className="inline text-brand-400 underline" href="/">
          početnu
        </Link>
      </p>
    </main>
